      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            <h3 className="font-display text-2xl font-bold tracking-[0.2em] mb-2">LINA POINT</h3>
            <p className="text-white/30 text-xs tracking-[0.3em] uppercase mb-6">Overwater Resort</p>
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-md">
              Disconnect once you step on the bridge. Reconnect with the magic within
              at Belize&apos;s premier overwater resort on Ambergris Caye.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs tracking-[0.25em] uppercase text-white/50 font-semibold mb-6">Explore</h4>
            <ul className="space-y-3">
              {FOOTER_LINKS.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-gray-400 hover:text-amber-400 text-sm transition">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h4 className="text-xs tracking-[0.25em] uppercase text-white/50 font-semibold mb-6">Contact</h4>
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li>
                <a href="mailto:reservations@linapoint.com" className="hover:text-amber-400 transition">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-xs">
            &copy; {new Date().getFullYear()} Lina Point Belize. All rights reserved.
          </p>
