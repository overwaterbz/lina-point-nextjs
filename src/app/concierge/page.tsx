    ...
    <FadeCard delay={index * 0.08}>
      ...
      >
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-gray-900 pr-4 group-hover:text-cyan-700 transition">
            {faq.q}
          </h3>
          <motion.span
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] min-h-[400px] overflow-hidden">
        <Image
          src="https://seonmgpsyyzbpcsrzjxi.supabase.co/storage/v1/object/public/LP/anniversary_cabana-8-scaled.jpg"
        ...
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white text-center md:text-left">
            ...
            <p className="text-white/70 text-sm">
              Get instant answers, book tours, and arrange your entire trip via
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6">
          <SectionHeading
            ...
            description="From trip planning to special requests — we handle everything so you can relax."
          />
            ...
            {[
              {
                ...
                desc: "Share your dates, interests, group size, and budget via WhatsApp or our booking form.",
              },
              {
                step: "02",
                title: "AI Builds Your Itinerary",
                desc: "Our Experience Curator AI assembles a personalized plan with the best tours, dining, and pricing.",
              },
              {
                step: "03",
                title: "Review & Customize",
                desc: "Adjust anything — swap tours, upgrade dining, add spa sessions. Your trip, your way.",
              },
              {
                step: "04",
                title: "Book & Enjoy",
                desc: "Secure your reservation with Square or Stripe payments. We handle the rest.",
              },
            ].map((item, i) => (
              <FadeCard key={item.step} delay={i * 0.15}>
                <div className="flex gap-6 items-start">
                  <span className="font-display text-4xl font-bold text-amber-500/30 flex-shrink-0 w-16">
                    {item.step}
                  </span>
                  <div>
