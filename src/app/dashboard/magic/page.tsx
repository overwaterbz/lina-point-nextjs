...
export default function MagicPage() {
  ...
  const handleGenerateNew = () => {
    ...
    toast.success(
      "Add 'Magic' to your booking to generate personalized content!",
    );
  };
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow-lg p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Add the &quot;Magic&quot; add-on to your next booking to generate a
            personalized song and video celebrating your special moment.
          </p>
          <button
                ...
                {content.status === "completed" && (
                  <div className="space-y-2">
                    {(content.content_type === "song" ||
                      content.content_type === "audio_remix") &&
                      content.media_url && (
                        <div>
